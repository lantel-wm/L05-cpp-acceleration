...
class ensembleFilter(ABC):
    ...
    @abstractmethod
    def calc_prior_rmse(self, zens:np.mat) -> float:
    ...
    @abstractmethod
    def calc_analysis_rmse(self, zens:np.mat, obs:np.mat) -> float:
    ...
    @abstractmethod
    def calc_prior_spread_rmse(self, zens:np.mat) -> float:
    ...
    @abstractmethod
    def calc_analysis_spread_rmse(self, zens:np.mat) -> float:
